...
export default function PublicPageScene({
  ...
  return (
    ...
    >
      ...
      <div className="public-page__stage">
        <div className="public-page__main-column">
          ...
          >
            ...
            {shareFeedback ? (
              <div className="public-page__share-feedback" style={theme.chromeButtonStyle}>
                {shareFeedback}
              </div>
            ) : null}
            ...
            <div className="public-page__shell-content">
              ...
              >
                ...
                <div className="public-page__hero">
                  <div className="public-page__hero-avatar-wrap" style={theme.chromeButtonStyle}>
              ...
              {socialLinks.length ? (
                ...
                >
                  <div className="public-page__social-header">
                    <span className="public-page__section-eyebrow">Redes sociais</span>
      ...
      {!previewMode ? (
        <aside className="public-page__desktop-aside" style={theme.qrPanelStyle}>
